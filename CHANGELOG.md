...
This release drops support for **ansible-core** releases older than 2.16 and updates **Python** guidance so **3.12** is explicitly included among supported versions.
